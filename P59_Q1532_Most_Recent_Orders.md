...
```sql
Create table If Not Exists Customers (customer_id int, customer_name varchar(10));
Create table If Not Exists Orders (order_id int, order_date date, customer_id int, cost int);
Truncate table Customers;
insert into Customers (customer_id, customer_name) values ('1', 'Winston');
insert into Customers (customer_id, customer_name) values ('2', 'Jonathan');
insert into Customers (customer_id, customer_name) values ('3', 'Annabelle');
insert into Customers (customer_id, customer_name) values ('4', 'Marwan');
insert into Customers (customer_id, customer_name) values ('5', 'Khaled');
...
WHERE c.date_rank <= 3
OR c.order_count < 3
ORDER BY cu.customer_name ASC, c.customer_id ASC, c.order_date DESC
;
```